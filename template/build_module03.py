...
for i, step in enumerate(steps):
    rect(s, Inches(0.7), Inches(3.12) + Inches(0.5) * i, Inches(0.32), Inches(0.32), GREEN_OK)
    tb(s, str(i + 1), Inches(0.7), Inches(3.14) + Inches(0.5) * i, Inches(0.32), Inches(0.28),
       fs=12, bold=True, color=WHITE, align=PP_ALIGN.CENTER)
    tb(s, step, Inches(1.15), Inches(3.10) + Inches(0.5) * i, Inches(6.8), Inches(0.36),
       fs=13, color=WHITE)
